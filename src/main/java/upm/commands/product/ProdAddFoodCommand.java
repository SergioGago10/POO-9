        ...
        if (args.length < 6) {
            ...
            try {
                ...
                try {
                    ...
                    CLI.print("Error -> Price must be double");
                    return false;
                }
                i++;
                ...
                if (Utilities.isValidProd(id, name, price)) {
                    if (i == args.length - 1) {
                        ...
                        if (creationDate.plusDays(3).isAfter(date)) {
                            CLI.print("Error -> The food should be planned at least 3 days before");
                            return true;
                        }
                        ...
                        if (LocalDateTime.now().plusDays(3).isAfter(date)) {
                            CLI.printErrorNextLine("Error -> The food should be planned at least 3 days before");
                            return true;
                        } else
