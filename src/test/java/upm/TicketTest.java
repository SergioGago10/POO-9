 ...
 private ByteArrayOutputStream out;
   ...
   @Test
    public void imprimeOrdenadoPorNombreAlfabetico() {
       ...
       // Dividir por "ticket add: ok" y quedarse con la última sección
       String[] sections = s.split("ticket add: ok");
       String lastSection = sections[sections.length - 2];

        // Extrae solo las líneas de producto
       String[] productLines = lastSection.lines()
